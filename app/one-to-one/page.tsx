          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <h1 className="max-w-3xl text-4xl font-black leading-tight tracking-tight sm:text-5xl lg:text-6xl">
                ...
                <span className="block text-orange-500">with a clear weekly plan.</span>
              </h1>
            ...
            <div className="lg:pl-8">
              <div className="rounded-[28px] border border-[#E8DFD3] bg-[#FFFDF9]/95 shadow-xl shadow-[#DCCFBD]/50 p-7 sm:p-8">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-7 inline-flex h-12 w-full items-center justify-center rounded-2xl bg-orange-500 text-base font-bold text-white hover:bg-orange-600 transition-colors"
                >
                  Apply for 1 to 1
                </a>
              </div>
