...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#070B12] text-white">
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-24">
          <div className="max-w-4xl">
            <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-slate-300">Cheze Grinds</p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              <a
                href="/services"
                className="inline-flex h-12 items-center rounded-lg bg-[#0F766E] px-7 text-base font-bold text-white hover:bg-[#0B5F59] transition-colors"
              >
                View our services
              ...
              <a
                href="/one-to-one"
                className="inline-flex h-12 items-center rounded-lg border border-white/15 bg-white/5 px-7 text-base font-bold text-white hover:bg-white/10 transition-colors"
              >
      ...
      <section>
        <div className="mx-auto max-w-7xl px-6 py-14 lg:px-8 lg:py-16">
          <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-slate-300">Social proof</p>
      ...
      <footer className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-8">
          <p className="text-sm text-slate-400">Cheze Grinds</p>
        </div>
      </footer>
    </div>
  );
