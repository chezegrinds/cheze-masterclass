export default function ConfirmedCork() {
  const googleCalendarUrl =
    "https://calendar.google.com/calendar/render?action=TEMPLATE" +
    "&text=" +
    encodeURIComponent("LC HL Maths Easter Crash Course — Cork") +
    "&dates=20260403T100000Z/20260404T150000Z" +
    "&details=" +
    encodeURIComponent(
      "Day 1: Fri 3 Apr — Probability & Statistics + Coordinate Geometry\nDay 2: Sat 4 Apr — Differentiation & Integration + Complex Numbers & Functions\n\nVenue details will be sent to your email before the event. Remaining balance of €199 to be paid on arrival."
    ) +
    "&location=" +
    encodeURIComponent("Cork City Centre — venue details to follow");

  const icsContent = `BEGIN:VCALENDAR
VERSION:2.0
BEGIN:VEVENT
DTSTART:20260403T110000
DTEND:20260403T160000
SUMMARY:LC HL Maths Easter Crash Course — Day 1 (Cork)
DESCRIPTION:Probability & Statistics + Coordinate Geometry. Venue details will be sent to your email. Balance of €199 to be paid on arrival.
LOCATION:Cork City Centre — venue details to follow
END:VEVENT
BEGIN:VEVENT
DTSTART:20260404T110000
DTEND:20260404T160000
SUMMARY:LC HL Maths Easter Crash Course — Day 2 (Cork)
DESCRIPTION:Differentiation & Integration + Complex Numbers & Functions. Venue details will be sent to your email. Balance of €199 to be paid on arrival.
LOCATION:Cork City Centre — venue details to follow
END:VEVENT
END:VCALENDAR`;
        ...
        <div className="relative mx-auto flex min-h-screen max-w-4xl items-center px-6 py-16 lg:px-8">
          <div className="w-full rounded-[32px] border border-[#E8DFD3] bg-[#FFFDF9]/95 p-8 shadow-xl shadow-[#DCCFBD]/50 sm:p-12">
            ...
            <h1 className="text-4xl font-black leading-tight tracking-tight sm:text-5xl">
              Seat secured.
              <span className="block text-orange-500">See you in Cork.</span>
            </h1>

            <p className="mt-4 max-w-xl text-lg leading-8 text-[#5F6470]">
              Your deposit for the <strong>Easter Revision Crash Course — Cork</strong> has been received and your seat is locked in.
            </p>
            ...
            {/* Balance reminder */}
            <div className="mt-6 rounded-[20px] border border-orange-200 bg-orange-50 p-5">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-orange-600">Balance due on arrival</p>
              <p className="mt-2 text-3xl font-black text-[#0C1B33]">€199</p>
              <p className="mt-1 text-sm text-[#6B7280]">Payable by cash or card on the day. Your €50 deposit has already been received.</p>
            </div>
            ...
            <div className="mt-8 rounded-[24px] border border-[#E8DFD3] bg-[#F3E8D7]/45 p-6">
              ...
              <p className="mt-3 text-base leading-7 text-[#3C4658]">
                This is where you'll get the venue address, reminders, and any updates before and during the course. Join now so you don't miss anything.
              </p>
              <a
                href="https://chat.whatsapp.com/By2kdXRjw0S03xMsavUnwa?mode=gi_t"
                target="_blank"
            ...
            <div className="mt-6 rounded-[24px] border border-[#E8DFD3] bg-[#FFFDF9] p-6">
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <a
                  href={icsHref}
                  download="easter-crash-course-cork.ics"
            ...
            <div className="mt-8 rounded-[24px] bg-[#0C1B33] p-6 text-white">
              ...
              <p className="mt-3 max-w-xl text-base leading-7 text-slate-200">
                Your deposit is non-refundable and your seat is confirmed. You don't need to do anything else right now — just keep an eye on your email for the venue details and reminders closer to the date.
              </p>
            </div>
